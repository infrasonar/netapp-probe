...
async def check_aggregate(
    ...
    url = '/api/storage/aggregates?fields=statistics,metric,*'
    ...
    return {
        'aggregate': [{
            ...
            'block_storage_primary_disk_type': item['block_storage']['primary']['disk_type'],
            ...
            'inactive_data_reporting_enabled': item['inactive_data_reporting']['enabled'],
            ...
            'snapshot_max_files_used': item['snapshot']['max_files_used'],
            'space_block_storage_available': item['space']['block_storage']['available'],
            'space_block_storage_data_compacted_count': item['space']['block_storage']['data_compacted_count'],
            'space_block_storage_data_compaction_space_saved': item['space']['block_storage']['data_compaction_space_saved'],
            'space_block_storage_data_compaction_space_saved_percent': item['space']['block_storage']['data_compaction_space_saved_percent'],
            'space_block_storage_full_threshold_percent': item['space']['block_storage']['full_threshold_percent'],
            'space_block_storage_physical_used': item['space']['block_storage']['physical_used'],
            'space_block_storage_physical_used_percent': item['space']['block_storage']['physical_used_percent'],
            'space_block_storage_size': item['space']['block_storage']['size'],
            'space_block_storage_used': item['space']['block_storage']['used'],
            'space_block_storage_volume_deduplication_shared_count': item['space']['block_storage']['volume_deduplication_shared_count'],
            'space_block_storage_volume_deduplication_space_saved': item['space']['block_storage']['volume_deduplication_space_saved'],
            ...
            'space_efficiency_without_snapshots_flexclones_savings': item['space']['efficiency_without_snapshots_flexclones']['savings'],
            'space_snapshot_available': item['space']['snapshot']['available'],
            'space_snapshot_reserve_percent': item['space']['snapshot']['reserve_percent'],
            'space_snapshot_total': item['space']['snapshot']['total'],
            'space_snapshot_used': item['space']['snapshot']['used'],
            'space_snapshot_used_percent': item['space']['snapshot']['used_percent'],
            'state': item['state'],
