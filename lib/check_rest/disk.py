...
async def check_disk(
    ...
    return {
        'disk': [{
            ...
            'stats_average_latency': item.get('stats', {}).get('average_latency'),
            'stats_iops_total': item.get('stats', {}).get('iops_total'),
            'stats_path_error_count': item.get('stats', {}).get('path_error_count'),
            'stats_power_on_hours': item.get('stats', {}).get('power_on_hours'),
