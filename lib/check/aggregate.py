    ...
    async def run(asset: Asset, local_config: dict, config: dict) -> dict:
        ...
        return {
            'aggregate': [{
                ...
                item.get('inactive_data_reporting', {}).get(
                    'enabled'),  # 9.8
                'name': item.get('name'),
                ...
                item.get('space', {}).get('efficiency', {}).get(
                    'logical_used'),
                ...
                item.get('space', {}).get(
                    'efficiency_without_snapshots', {}).get('logical_used'),
                ...
                item.get('space', {}).get(
                    'efficiency_without_snapshots', {}).get('savings'),
